 ...
 * @author Roberto
 */
public class InterfazInfoPersona extends javax.swing.JDialog {

    /**
     * Creates new form InterfazInfoPersona
     */
    public InterfazInfoPersona(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        apellido1.setText("jLabel8");

        apellido2.setText("jLabel9");

        dni.setText("jLabel10");

        telefono.setText("jLabel11");

        jLabel12.setText("Correo electronico");

        correo.setText("jLabel13");

        jLabel7.setText("Eda:");

        edad.setText("jLabel8");
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(InterfazInfoPersona.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                InterfazInfoPersona dialog = new InterfazInfoPersona(new javax.swing.JFrame(), true);
